...
def transform_for_main_model(site_data: dict, vectorizer) -> sp.csr_matrix:
...
def main():
    ...
    parser.add_argument('--model', type=str, default='main',
                        choices=['main', 'content_only', 'url_only'],
                        help="The model to use: 'main', 'content_only', or 'url_only'.")
    ...
    for url in args.urls:
        ...
        try:
            if args.model == 'main':
                ...
                features = transform_for_main_model(site_data, vectorizer)
